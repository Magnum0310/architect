      ...
      <motion.div className="grid grid-cols-12 grid-rows-10 max-md:hidden">
        <motion.div className="col-start-1 col-end-13 row-start-1 row-end-11 ">
          <motion.div
            ...
            style={{
              backgroundImage: `url(${Image.Project})`,
              y: imageScroll,
            }}
          />
        </motion.div>
        ...
        <div className="col-start-4 col-end-11 row-start-3 row-end-10 max-lg:col-start-3 max-lg:col-end-12">
          <div className="relative grid h-full grid-cols-7 grid-rows-7 ">
            ...
            >
              <span className="text-title-color">{Details.project.title}</span>
            </motion.div>
            <motion.div
              className="service-title z-10 col-start-3 col-end-7 row-start-2 row-end-4 flex items-center"
              style={{ y: yTitle, opacity: yOpacity }}
            >
            ...
            >
              <span>{Details.project.descriptionTitle}</span>
            </motion.div>
            {/* SERVICE DESCRIPTION */}
            <motion.div
