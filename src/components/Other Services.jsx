...
const PageTemplate = () => {
  return (
    <>
      ...
      {/* MOBILE */}
      <div className="grid w-screen flex-col  max-xs:h-full max-xs:grid-cols-6 max-xs:grid-rows-4 max-xs:gap-0 md:hidden">
        ...
        <div className="relative z-20 h-full max-xs:col-span-5 max-xs:col-start-2 max-xs:row-start-2  max-xs:place-items-center">
          <div className="relative flex flex-col gap-10 bg-primaryBackground bg-opacity-45 max-xs:py-4 max-xs:pl-2 max-xs:pr-4">
            ...
            <div className="text-subtitle-description-color relative hidden font-Fahkwang font-thin  max-xs:text-left max-xs:text-lg">
        ...
        <div className="hidden h-full w-full max-xs:absolute">
