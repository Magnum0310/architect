...
const PageTemplate = () => {
  ...
  return (
    <>
      ...
      {/* MOBILE */}
      <div
        className="justify grid max-md:h-full max-md:grid-cols-6 max-md:grid-rows-4 max-md:gap-0 md:hidden "
        ref={mobileRef}
      >
        ...
        {mobileView ? (
          <div className="relative flex h-full place-items-center max-md:col-span-5 max-md:col-start-2 max-md:row-span-4 max-md:row-start-1">
            <motion.div
              className="relative flex h-full flex-col bg-primaryBackground  bg-opacity-45 max-md:py-4 max-md:pl-2 max-md:pr-4 max-xs:justify-end max-xs:gap-2 xs:justify-center xs:gap-5"
              variants={primaryVariant}
              animate="animate"
              initial="initial"
            >
              ...
              <motion.div
                className="text-subtitle-color text-page-section-title  max-md:text-left"
                variants={titleVariant}
              >
                Discover our comprehensive range of services
              </motion.div>
              {/* </div> */}
              <motion.div
                className="text-subtitle-description-color text-page-section-content relative w-full font-Fahkwang font-thin"
                variants={leftTextVariant}
              >
                Discover our diverse expertise. From architectural design to
                construction, our talented team brings creativity and innovation
