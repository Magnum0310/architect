  ...
  return (
    <>
      ...
      <div className="grid h-[130vh] grid-cols-12 grid-rows-10 max-md:hidden">
        <div className="text-page-title-color text-page-section col-start-1 col-end-2 row-start-1 row-end-2 flex h-[6rem] items-end justify-center border-b-4 border-r-4 border-solid border-goldLines pb-2">
          ABOUT US
        </div>
        ...
        <div className="col-start-3 col-end-11 row-start-2 row-end-6 grid">
          <div className="relative flex h-full w-full flex-col justify-evenly gap-12">
            ...
            <div className="text-page-section-content text-subtitle-description-color ml-48 font-Fahkwang font-thin">
