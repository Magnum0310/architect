        ...
        <motion.div className="grid grid-cols-12 grid-rows-10">
          ...
          <div className="col-start-4 col-end-11 row-start-3 row-end-10">
            <div className="relative grid h-full grid-cols-7 grid-rows-7 ">
              ...
              >
                <span className="text-title-color">Landscape</span>
              </motion.div>
              <motion.div
              ...
              >
                <span>
                  Enrich your outdoor spaces with our expert landscape design
                  services. Our landscape architects blend artistry with
                  environmental consciousness to create outdoor environments
                  that seamlessly integrate with their surroundings. Whether
                  it's a serene garden retreat or a dynamic outdoor
                  entertainment area, we'll design landscapes that captivate the
