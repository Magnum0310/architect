...
const ServicesPage = ({ scrollYProgress }) => {
  const element = useRef(null);
  // const { scrollYProgress } = useScroll({
  //   target: element,
  //   offset: ["0 .5", "end end"],
  // });
  const yInterior = useTransform(scrollYProgress, [0, 0.005], [15, 0]);
  const yOpacity = useTransform(scrollYProgress, [0, 0.005], [0, 1]);
          ...
          <div className="col-start-4 col-end-11 row-start-3 row-end-10">
            <div className="relative grid h-full grid-cols-7 grid-rows-7 ">
              ...
              <motion.div
                ...
                style={{ y: yInterior, opacity: yOpacity }}
              >
                <span className="text-title-color">Architectural</span>
              </motion.div>
              <motion.div className="text-title z-10 col-start-4 col-end-7 row-start-2 row-end-4 flex  items-center">
                <span className="text-title-color">Interiors</span>
              </motion.div>
              {/* SERVICE SUBTITLE */}
              <motion.div className="text-subtitle-description-color text-service-description  z-10 col-start-1 col-end-4 row-start-4 row-end-5 flex  justify-center font-Fahkwang">
                <span>Architectural Interiors</span>
              </motion.div>
              {/* SERVICE DESCRIPTION */}
              <motion.div className="text-subtitle-description-color text-service-description z-10 col-start-4 col-end-7 row-start-4 row-end-7  font-Fahkwang">
                <span>
                  "Meet our creative interior designers, who bring warmth,
                  style, and functionality to every space. With an eye for
                  detail and a passion for design, they transform interiors into
                  inviting and inspiring environments. Whether it's a
                  residential project or a commercial space, we'll create
                  interiors that enhance your lifestyle and leave a lasting
                  impression."
                </span>
              </motion.div>
              {/* HIGHTLIGHTS */}
        ...
        <motion.div className=" grid h-screen grid-cols-12 grid-rows-10">
          ...
          <div className="col-start-4 col-end-11 row-start-3 row-end-10">
            <div className="relative grid h-full grid-cols-7 grid-rows-7 ">
              ...
              <div className="col-start-1 col-end-9 row-start-2 row-end-10  bg-primaryBackground opacity-45"></div>
              {/* SERVICE TITLE */}
              <motion.div className=" text-title z-10 col-start-1 col-end-6 row-start-1 row-end-3 flex items-center justify-center">
                <span className="text-title-color">Architectural</span>
              </motion.div>
              <motion.div className="text-title z-10 col-start-4 col-end-7 row-start-2 row-end-4 flex  items-center">
                <span className="text-title-color">Interiors</span>
